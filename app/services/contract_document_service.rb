      ...
      documents: {
        ...
        contract: [
          {
            ...
            caution: "계약금액 3,000만원 이상 시 계약서 작성 의무",
        ...
        payment: [
          ...
          },
          {
            ...
            legal_basis: "지방재정법 제47조",
            caution: "검수 완료 후 5일 이내 대금 청구 가능",
            tip: "지급기한: 청구일로부터 14일 이내 (지연 시 이자 발생)"
          }
        ]
      }
    },
      ...
      documents: {
        pre_contract: [
          {
            ...
            legal_basis: "지방계약법 시행령 제14조, 건설기술진흥법 제48조",
        ...
        contract: [
          ...
          },
          {
            ...
            description: "계약금액 10%",
            legal_basis: "지방계약법 시행령 제51조, 건설산업기본법 제34조",
        ...
        execution: [
          {
            ...
            legal_basis: "건설산업기본법 제22조, 지방계약법 시행령 제59조",
        ...
        completion: [
          {
            ...
            legal_basis: "지방계약법 시행령 제63조, 건설산업기본법 제28조",
