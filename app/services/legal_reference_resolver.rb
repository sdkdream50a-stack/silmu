...
class LegalReferenceResolver
  ...
  KNOWN_LAWS = {
    ...
    "국가재정법" => "국가재정법",
    "국고금관리법" => "국고금 관리법",
    # P4 — `contract-guarantee` 가 인지세를 실제로 계산한다(STAMP_TAX_TABLE).
    # 법제처 실측 2026-09-20: 「인지세법」 MST 276139 · 현행 · 시행 2026-01-02.
    "인지세법" => "인지세법",
    ...
    "공무원 여비 규정" => "공무원 여비 규정",
    "공무원여비규정" => "공무원 여비 규정",
    # 「지방공무원 여비 규정」은 **존재하지 않는 법령**이라 허용목록에서 뺐다(G-34 · 2026-09-17 law.go.kr 실측).
    # 허용목록에 두면 없는 법령을 law.go.kr 링크로 «승격» 시켜 오히려 권위를 만든다.
    # 지방공무원 여비는 각 지방자치단체 여비 조례가 정한다 — 조례는 법령 링크 대상이 아니다.
