...
class ProgressInspectionService
  ...
  # 법적 근거
  LEGAL_REFERENCES = [
    { law: "지방계약법 시행령 제64조 (검사)", content: "검사는 계약서·설계서 등에 따라 이행 여부를 확인" },
    { law: "지방계약법 시행령 제66조 (감독과 검사 직무의 겸직)", content: "감독과 검사 직무는 원칙적으로 겸할 수 없음 (예외 규정 적용)" },
    { law: "지방계약법 시행령 제67조 (대가의 지급)", content: "검사 완료 후 계약상대자의 청구를 받은 날부터 5일 이내 대가 지급 (본조 ①항). 기성대가는 30일마다 지급 (③항)" },
    { law: "지방계약법 시행령 제64조 ⑥항", content: "기성대가 지급 시 기성검사는 감독조서 확인으로 갈음 가능, 검사 3회마다 1회는 정식 검사 실시" },
    { law: "지방계약법 시행령 제65조 (검사조서의 작성 생략)·제68조 (대가 지급 지연 이자)", content: "계약금액 3천만원 이하 시 검사조서 작성 생략 가능 (§65) + 대가 지연 시 이자 부과 (§68)" }
  ].freeze
