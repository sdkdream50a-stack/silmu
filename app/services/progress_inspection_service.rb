...
class ProgressInspectionService
  ...
  LEGAL_REFERENCES = [
    ...
    { law: "지방계약법 시행령 제67조 (대가의 지급)", content: "검사 완료 후 대가 지급 — 본조 ⑥항: 기성대가 지급 시 기성검사는 감독조서 확인으로 갈음 가능, 3회마다 1회는 정식 검사 실시" },
    { law: "지방계약법 시행령 제65조 (검사조서의 작성 생략)·제68조 (대가 지급 지연 이자)", content: "검사조서 작성 생략 가능 사유 + 대가 지연 시 이자 부과" }
  ].freeze
