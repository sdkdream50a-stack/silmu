  ...
  class << self
    ...
    def generate_warnings(type, price)
      ...
      if threshold && threshold[:method] == "입찰"
        warnings << {
          ...
          message: "2회 유찰(재공고 포함) 시 수의계약으로 전환할 수 있습니다. 이 경우 최초 입찰에 부친 내용과 동일한 조건이어야 하며, 예정가격 이내로 계약해야 합니다. (지방계약법 시행령 제26조제1항)"
        }
      end
    ...
    def generate_tips(type, price, method)
      ...
      if method.include?("입찰")
        ...
        tips << "2회 유찰 시 수의계약 전환이 가능합니다. (지방계약법 시행령 제26조제1항)"
      end
