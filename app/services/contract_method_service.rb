...
class ContractMethodService
      ...
      thresholds: [
        {
          max: 2_000_000,
          method: "소액수의계약",
          method_detail: "1인 견적 가능",
          basis: "지방계약법 시행령 제25조제1항제5호",
          note: "추정가격 200만원 이하",
        ...
        },
        {
          ...
          basis: "지방계약법 시행령 제25조제1항제5호, 제30조제1항",
          note: "추정가격 5천만원 이하 (여성·장애인·사회적기업은 5천만원까지 1인 수의 가능)",
          special_condition: "중소기업자간 경쟁제품 해당 여부 확인 필요",
        ...
        },
        {
          ...
          basis: "지방계약법 시행령 제25조제1항제5호",
          note: "추정가격 1억원 이하",
          special_condition: "중소기업자간 경쟁제품 해당 시 중소기업자만 참여",
    ...
    service: {
      ...
      thresholds: [
        ...
        },
        {
          ...
          basis: "지방계약법 시행령 제25조제1항제5호, 제30조제1항",
          note: "추정가격 5천만원 이하 (여성·장애인·사회적기업은 5천만원까지 1인 수의 가능)",
          special_condition: "기술용역은 학술연구용역 등 예외 규정 확인",
        ...
        },
        {
          ...
          basis: "지방계약법 시행령 제25조제1항제5호",
          note: "추정가격 1억원 이하",
          special_condition: "용역의 특성상 특정인 수의계약 가능 여부 검토 (제25조제1항제4호)",
          documents: %w[견적서(2인이상) 견적비교표 과업지시서 사업자등록증사본 청렴서약서 수의계약사유서]
        },
        {
          max: Float::INFINITY,
          ...
          note: "추정가격 1억원 초과 (기술용역은 협상계약 검토)",
    ...
    construction_general: {
      ...
      thresholds: [
        ...
        },
        {
          ...
          method_detail: "1인 견적 수의계약",
          basis: "지방계약법 시행령 제25조제1항제5호",
          note: "추정가격 2천만원 이하 (건설업 등록 필요 없음)",
        ...
        },
        {
          ...
          method: "수의계약",
          method_detail: "2인 이상 견적 수의계약",
          basis: "지방계약법 시행령 제25조제1항제5호, 건설산업기본법",
          note: "추정가격 8천만원 이하 (경미한 건설공사)",
          special_condition: "8천만원 이하는 건설업 등록 없이도 시공 가능",
        ...
        },
        {
          ...
          basis: "지방계약법 시행령 제25조제1항제5호",
          note: "추정가격 4억원 이하",
          special_condition: "건설업 등록업체만 참여 가능, 안전관리계획서 필요",
          documents: %w[견적서(2인이상) 견적비교표 설계서 예정가격조서 건설업등록증 사업자등록증사본 청렴서약서 수의계약사유서 안전관리계획]
        },
        {
          max: Float::INFINITY,
          method: "입찰",
    ...
    construction_special: {
      ...
      thresholds: [
        ...
        },
        {
          ...
          special_condition: "해당 전문공사업 등록업체 또는 경미공사 범위 내 시공",
          documents: %w[견적서(2인이상) 견적비교표 설계서 사업자등록증사본 청렴서약서 수의계약사유서]
        },
        {
          max: 200_000_000,
    ...
    construction_etc: {
      ...
      thresholds: [
        ...
        },
        {
          ...
          method: "수의계약",
          method_detail: "2인 이상 견적 수의계약",
          basis: "각 개별법령(전기공사업법 등), 지방계약법 시행령",
          note: "추정가격 5천만원 이하 (경미한 공사)",
          special_condition: "경미한 전기/소방/정보통신공사는 등록 없이 가능",
          documents: %w[견적서(2인이상) 견적비교표 설계서 사업자등록증사본 청렴서약서 수의계약사유서]
        },
        {
          max: 160_000_000,
  ...
  class << self
    ...
    def generate_warnings(type, price)
      ...
      # 건설업 등록 확인 경고
      if [ :construction_general, :construction_special, :construction_etc ].include?(type) && price > 80_000_000
        warnings << {
          level: "warning",
          title: "건설업 등록 확인 필요",
          message: "추정가격 8천만원 초과 시 해당 건설업 등록업체만 참여 가능합니다.",
