    ...
    service: {
      ...
      thresholds: [
        ...
        },
        {
          ...
          basis: "지방계약법 시행령 제25조제1항제5호 나목",
          note: "추정가격 2천만원 이하 (예정가격 작성 생략 가능 — 시행령 제9조)",
          documents: %w[체결제한확인서 견적서 사업자등록증사본 청렴서약서 과업지시서]
        },
        {
          max: 50_000_000,
          method: "수의계약",
          ...
          note: "추정가격 5천만원 이하 (학술연구 등 특수분야 또는 여성·장애인·사회적기업 등 해당 시). G2B 전자견적 필수",
          special_condition: "일반 업체와의 계약은 2천만원 초과 시 경쟁입찰 대상. 특례기업은 5천만원까지 1인 견적 가능",
          documents: %w[체결제한확인서 견적서(2인이상) 견적비교표 과업지시서 예정가격조서 사업자등록증사본 청렴서약서 수의계약사유서]
        },
        {
          max: 100_000_000,
          method: "수의계약",
          ...
          documents: %w[체결제한확인서 견적서(2인이상) 견적비교표 과업지시서 예정가격조서 사업자등록증사본 청렴서약서 수의계약사유서 중소기업확인서]
        },
        {
          max: Float::INFINITY,
          method: "입찰",
