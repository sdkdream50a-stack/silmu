module ToolsHelper
  ...
  def tools_registry
    [
      ...
      { title: "성과상여금 계산기",             desc: "월봉급액과 소속 기관 지급계획의 지급률을 입력하면 성과상여금을 계산합니다.",                  icon: "emoji_events",      color: "amber",   category: "계산기",      domain: "인사", path: performance_bonus_calculator_path,  badge: "NEW", keywords: "성과급, 공공기관 성과급" },
