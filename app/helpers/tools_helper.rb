module ToolsHelper
  ...
  def tools_registry
    [
      { title: "계약방식 결정 도우미",         desc: "추정가격과 계약유형으로 적정 계약방식과 필요서류를 확인합니다.",                icon: "gavel",            color: "emerald", category: "자동화 도구", domain: "계약", path: contract_method_path,               badge: "인기", keywords: "수의계약, 입찰, 추정가격, 한도, 수의계약한도, 소액수의" },
      ...
      { title: "계약문서 생성기",               desc: "구매규격서·과업내용서(과업지시서)를 단계별로 작성합니다.",               icon: "description",       color: "emerald", category: "문서 도구",   domain: "계약", path: "/forms/과업지시서.html" },
      ...
      { title: "여비계산기",                   desc: "출장 여비(운임, 숙박비, 식비, 일비)를 자동으로 계산합니다.",                    icon: "directions_car",    color: "indigo",  category: "계산기",      domain: "여비", path: travel_calculator_path,             badge: "인기", keywords: "출장비, 일비, 식비, 숙박비, 운임, 자가용, 국외출장" },
      ...
      { title: "계약보증금 계산기",             desc: "계약보증금·하자보증금·인지세를 계약금액에 따라 자동으로 계산합니다.",            icon: "shield",            color: "indigo",  category: "계산기",      domain: "계약", path: contract_guarantee_path,            keywords: "수입인지" },
      { title: "적격심사 입찰률 확인",          desc: "낙찰하한율 미달 여부와 입찰률을 확인합니다. 가격평점은 예규 별표 산식이라 산출하지 않습니다.",               icon: "fact_check",        color: "emerald", category: "계산기",      domain: "계약", path: qualification_evaluation_path,      badge: "NEW" },
      ...
      { title: "예비비 한도 계산기",            desc: "예산 총액을 입력하면 지방재정법상 예비비 법정 한도(상한 1%)를 계산합니다. 법정 하한은 없습니다.", icon: "savings", color: "amber", category: "계산기", domain: "예산", path: contingency_fund_path,             badge: "NEW" },
      { title: "초과근무수당 계산기",           desc: "계급과 시간외·야간·휴일 근무시간을 입력하면 계급별 기준호봉 단가로 초과근무수당을 계산합니다.",  icon: "schedule",          color: "indigo",  category: "계산기",      domain: "인사", path: overtime_calculator_path,           keywords: "시간외수당, 야간수당, 휴일수당, 시간당 단가" },
      { title: "연가일수 계산기",               desc: "임용일을 입력하면 재직 기간별 부여 연가일수, 잔여 연가, 연가보상비를 자동 계산합니다.", icon: "event_available", color: "emerald", category: "계산기",   domain: "인사", path: annual_leave_calculator_path,          keywords: "신규직원, 신규 임용, 연차" },
      ...
      { title: "성과상여금 계산기",             desc: "계급과 소속 기관 지급률을 입력하면 성과상여금을 계산합니다(계급별 전년도 호봉 봉급 적용).",                  icon: "emoji_events",      color: "amber",   category: "계산기",      domain: "인사", path: performance_bonus_calculator_path,  badge: "NEW", keywords: "성과급, 공공기관 성과급" },
      { title: "분할계약 판단 체크리스트",      desc: "계약 분할이 감사 지적 대상인지 5가지 기준으로 즉시 확인합니다.",                  icon: "rule",              color: "red",     category: "체크리스트",  domain: "계약", path: split_contract_checker_path,        badge: "NEW", keywords: "분할발주, 분리발주" },
      ...
      { title: "예정가격 복수예비가격 계산기",  desc: "기초금액에서 15개 복수예비가격을 만들고 4개 추첨 평균과 하한가를 시뮬레이션합니다.", icon: "casino",            color: "emerald", category: "계산기",      domain: "계약", path: predetermined_price_path,          badge: "NEW", keywords: "복수예비가격, 예정가격, 기초금액, 낙찰하한율, 예비가격" },
