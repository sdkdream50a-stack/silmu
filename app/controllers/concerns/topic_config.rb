...
module TopicConfig
  ...
  TOPIC_TOOLS = {
    ...
    "estimated-price"         => [ :predetermined_price, :estimated_price, :cost_estimate, :budget_estimator ],
  ...
  FLOWCHART_SLUGS = %w[
    ...
    estimated-payment fence-installation instructor-allowance estimated-amount
  ].freeze
  ...
  TOPIC_ICONS = {
    ...
    # 2026-06-01 추가 (SearchLog 갭 — 추정가격·추정금액·예정가격)
    "estimated-amount"             => "calculate"
  }.freeze
  ...
  TOOL_DEFINITIONS = {
    ...
    predetermined_price: { icon: "casino",      title: "예정가격 시뮬레이션", desc: "15개 예비가격·4개 추첨 평균", color: "emerald" },
