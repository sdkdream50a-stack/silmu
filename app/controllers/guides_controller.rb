class GuidesController < ApplicationController
  ...
  def index
    set_meta_tags(
      ...
      og: { title: "업무 가이드 — 실무", url: request.original_url }
    )
  end
  ...
  def contract_flow
    set_meta_tags(
      ...
      og: { title: "계약 흐름도 — 실무", url: request.original_url }
    )
  end
  ...
  def pre_contract_checklist
    set_meta_tags(
      ...
      og: { title: "계약업무 사전 체크리스트 — 실무", url: request.original_url }
    )
  end
  ...
  def resources
    set_meta_tags(
      ...
      og: { title: "자료실 — 실무", url: request.original_url }
    )
    @resources = [
