  ...
  GUIDES = {
    1 => {
      ...
      sections: {
        ...
        cautions: ["2천만원 이상 물품 구매 시 반드시 입찰을 통해 계약해야 합니다.", "동일 업체와 연속 3회 이상 수의계약 시 청렴성 문제가 발생할 수 있습니다.", "분할계약 금지 - 동일 목적의 계약을 나누어 수의계약하면 안 됩니다.", "납품 전 선금 지급은 원칙적으로 불가합니다. (계약이행보증 필요)"],
    ...
    4 => {
      ...
      sections: {
        ...
        step2: { title: "견적서 징구", items: ["2개 이상 업체로부터 견적서를 받습니다.", "1천만원 이하는 1개 업체 견적도 가능합니다.", "견적서의 유효기간과 조건을 확인합니다."] },
