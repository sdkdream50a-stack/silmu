...
class FaqController < ApplicationController
  def index
    ...
    set_meta_tags(
      ...
      og: { title: "자주 묻는 질문 — 실무", url: request.original_url }
    )
  end
    ...
    [
      ...
      },
      {
        ...
        faqs: [
          ...
          { q: "전자견적에 업체가 1개만 참여하면?", a: "2인 견적이 필요한 경우 기간을 연장하거나 재공고합니다.\n\n1차: 견적 기간 연장\n2차: 재공고 (규격 완화 검토)\n재공고에도 1인만 참여: 1인 수의계약 가능" },
