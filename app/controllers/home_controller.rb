class HomeController < ApplicationController
  def index
    set_meta_tags(
      ...
      og: { title: "실무.kr — 공무원 계약 실무 가이드", url: request.original_url }
    )
  end
  ...
  def about
    set_meta_tags(
      ...
      og: { title: "실무.kr 서비스 소개", url: request.original_url }
    )
  end
  ...
  def privacy
    set_meta_tags(
      ...
      og: { title: "실무.kr 개인정보처리방침", url: request.original_url }
    )
  end
  ...
  def terms
    set_meta_tags(
      ...
      og: { title: "실무.kr 이용약관", url: request.original_url }
    )
  end
end
