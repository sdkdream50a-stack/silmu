class Exam::HomeController < ApplicationController
  ...
  def index
    ...
    set_meta_tags(
      title: "공공조달관리사 시험 대비",
      description: "2026년 신설 공공조달관리사 국가기술자격시험을 체계적으로 준비하세요. 표준교재 4권 28장 전 범위 핵심 내용 정리, 현행 법령 조문 해설, 250여 건 감사사례·110여 개 법령 가이드를 무료 제공합니다. 공무원·공공기관 종사자를 위한 핵심 정리와 암기법을 한 곳에서 완성하세요.",
