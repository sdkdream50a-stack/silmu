...
# docker build -t silmu .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name silmu silmu
...
RUN python3 -m venv /opt/hwpx-venv && \
    /opt/hwpx-venv/bin/pip install --no-cache-dir python-hwpx
