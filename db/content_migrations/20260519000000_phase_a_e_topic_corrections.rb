# P6 Phase 2 — db/seeds/topic_correction_2026_05_19.rb 컨버전
#
# 2026-05-19 batch #2 — 지방계약법 시행령 §42 + bid-deposit 부정확 인용 운영 patch
# 정정 사유:
#   - 시행령 §42(낙찰자 결정)를 "경쟁입찰의 성립/2인 이상" 근거로 잘못 인용
#   - 정확: 행안부 예규 「지방자치단체 입찰 및 계약 집행기준」 + 시행령 §19(재입찰)
#   - bid-deposit: §41(수입입찰 낙찰)·§78(장기계속계약) → §37·§38 정정
#
# 운영 DB에는 이미 적용 완료. ContentMigration 첫 실행 시 [unchanged] 예상 (gsub 패턴 0건 매칭).
