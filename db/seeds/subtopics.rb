...
**A:** 계약금액 **5천만원 이하**인 계약이면 공사·물품·용역 구분 없이 계약서 작성을 생략할 수 있습니다(지방계약법 시행령 제50조제1항제1호). 경매, 물품 매각 시 매수인 즉시 대금 납부, 국가기관·다른 지방자치단체와의 계약, 전기·가스·수도 공급계약 등도 생략 대상입니다. 다만, 청구서, 납품서 등으로 계약 내용을 확인할 수 있어야 합니다.
...
### Q. 부가세 포함 5천만원 물품, 수의계약 가능 여부

**A:** 가능합니다. 추정가격은 부가세를 제외한 금액으로 산정합니다.
- 부가세 포함 5천만원 ÷ 1.1 = **약 4,545만원** (추정가격)
...
### 사례 1: 수의계약 한도 초과 계약
**지적사항:** 추정가격 5천만원(부가세 별도) 물품을 수의계약으로 체결
**관련근거:** 지방계약법 시행령 제25조
**조치내용:** 계약 취소, 관련자 중징계

> 일반 물품(소기업·특례기업 아님)의 수의계약 한도는 2천만원인데, 5천만원 물품을 수의계약으로 체결
...
- 예: 부가세 포함 2천만원 → 추정가격 약 1,818만원 (2천만원 이하) → 수의계약 가능
...
- 부가세 포함 금액 ÷ 1.1 = 추정가격
- 예: 부가세 포함 2천만원 → 추정가격 약 1,818만원 (2천만원 이하이므로 수의계약 가능)
...
**A:** 네, **2천만원 이하**이므로 1인 견적이 가능합니다. "이하"는 해당 금액을 포함합니다.
    ...
    faqs: [
      ...
      { question: '부가세 포함 2천만원이면 수의계약이 가능한가요?', answer: '아니요. 부가세 포함 2천만원 ÷ 1.1 = 2,000만원(추정가격)입니다. 추정가격 2천만원 이하이므로 물품·용역 수의계약이 가능합니다. 다만 추정가격이 정확히 한도와 같을 때는 부가세 제외 여부를 신중히 확인하세요.' }
    ].to_json,
    published: true
  },
  {
    ...
    law_content: <<~LAW,
      ...
      <div style="background:#eff6ff; padding:12px; border-radius:8px; margin-top:12px;">
        📌 긴급수의계약의 구체적 사유는 <strong>시행령 제25조 제1항 제1호</strong>에서 규정합니다: 천재지변, 긴급한 행사, 원자재 가격급등 등 경쟁에 부칠 여유가 없는 경우
      </div>
    LAW
    decree_content: <<~DECREE,
