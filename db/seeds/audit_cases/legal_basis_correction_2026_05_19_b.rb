...
#   - §18(근무지 내 국내 출장)을 자가용 여비로 잘못 인용 → 별표 2 + 「공무원 여비 업무 처리 기준」
  ...
  },
  {
    ...
    body_substitutions: [
      ["공무원여비규정 제18조 및 지방공무원 여비규정 제18조는 자가용 여비를 \"출발지로부터 목적지까지의 실제 사용 거리\"를 기준으로 계산합니다",
       "공무원여비규정 별표 2(자가용승용차 사용 시 여비 지급 기준) 및 인사혁신처 「공무원 여비 업무 처리 기준」은 자가용 여비를 \"출발지로부터 목적지까지의 실제 사용 거리\"를 기준으로 계산합니다"],
      ["공무원여비규정 제18조는 자가용 여비를 \"실제 사용 거리\"를 기준으로 계산하도록 규정합니다",
       "공무원여비규정 별표 2 및 인사혁신처 「공무원 여비 업무 처리 기준」은 자가용 여비를 \"실제 사용 거리\"를 기준으로 계산하도록 규정합니다"]
    ],
    legal_basis: "공무원여비규정 별표 2(자가용승용차 사용 시 여비 지급 기준) + 인사혁신처 「공무원 여비 업무 처리 기준」, 지방공무원 여비규정 별표(자가용 여비)"
  }
]
