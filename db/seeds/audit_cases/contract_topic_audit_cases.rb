...
담당자는 이 사업을 "기성 소프트웨어 패키지 구매"로 분류하여, 지방계약법 시행령 제25조 제1항 제5호 나목의 물품 수의계약 기준(2,000만원 초과 시 경쟁 원칙)을 무시하고 특정 IT 업체 A사와 직접 수의계약을 체결했습니다.
...
AuditCase.find_or_create_by!(slug: 'long-term-contract-annual-omission') do |ac|
  ...
  ac.legal_basis = '지방계약법 시행령 제78조(장기계속계약), 지방계약법 시행령 제78조 제2항(각 회계연도 예산 범위 계약), 지방자치단체 입찰 및 계약 집행기준(행정안전부 예규) 제7장 장기계속계약 집행기준'
  ac.issue = '△△군이 청사 경비 용역을 3개년 장기계속계약으로 체결하면서 2·3차 연도 연차별 계약을 체결하지 않은 상태에서 업체에 이행을 요구하여, 용역업체의 근로자 임금 미지급 문제가 발생하고 감사에서 지방계약법 시행령 제78조 위반으로 적발됨.'
...
지방계약법 시행령 제78조에 따른 장기계속계약의 핵심 구조는 다음과 같습니다.
...
**주요 위반 사항:**
1. 지방계약법 시행령 제78조 위반: 2·3차 연도 연차별 계약 미체결
...
AuditCase.find_or_create_by!(slug: 'lowest-bid-rate-violation-award') do |ac|
  ...
  ac.legal_basis = '지방계약법 시행령 제42조(낙찰자 결정) + 행정안전부 예규 「지방자치단체 입찰 및 계약 집행기준」 제5장 제3절 (낙찰하한율 산정)'
...
AuditCase.find_or_create_by!(slug: 'multiple-price-manipulation') do |ac|
  ...
  ac.legal_basis = '지방계약법 시행령 제9조(예정가격의 결정방법), 지방계약법 시행령 제42조(낙찰자 결정), 행정안전부 예규(지방자치단체 입찰 및 계약집행기준 ±3% 복수예비가격), 지방계약법 모법 제31조(부정당업자의 입찰 참가자격 제한), 형법 제123조(직권남용)'
...
AuditCase.find_or_create_by!(slug: 'national-local-contract-law-mix') do |ac|
  ...
  ac.legal_basis = '국가계약법 제1조(목적) 및 제2조(적용범위), 지방계약법 제1조(목적) 및 제2조(적용범위), 보조금 관리에 관한 법률 제22조(보조금의 집행), 재정경제부 계약예규(정부입찰·계약 집행기준)'
...
| 적격심사 기준 | 재정경제부 적격심사 기준 | **행안부 적격심사 기준** | 세부 평가 배점 상이 |
...
**불명확한 경우:** 해당 보조사업 주관 중앙부처 또는 기획예산처에 법령 적용 기준 문의
...
공고문에 "○○법 시행령 제○조에 의거"를 명기할 때 잘못된 법령을 기재하면 공고 자체가 무효가 될 수 있습니다. 공고 작성 전 법령 적용 기준을 재확인하세요.
  ...
  ac.checkpoints = [
    ...
    '적격심사 기준 서류: 재정경제부 예규 vs 행안부 예규 구분 적용',
