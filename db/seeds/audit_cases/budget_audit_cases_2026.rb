...
### 1. 지출원인행위는 반드시 집행 전에
지방회계법 제29조는 지출의 원인이 되는 행위(계약, 품의)를 예산 범위 내에서 먼저 하도록 규정합니다. "급하니까 먼저 받고 나중에 처리"는 위법입니다.
...
천재지변 등 정말 긴급한 경우에는 예비비 또는 긴급 품의 후 즉시 집행하는 절차가 있습니다. 이 경우도 사유를 서면으로 기록해야 합니다.
  ...
  },
  {
    ...
    legal_basis: "지방재정법 제47조의2(예산의 이용·이체), 제49조(예산의 전용), 지방자치법 제47조(지방의회의 의결사항)",
...
예비비를 자주 사용하는 부서는 "예산 편성 능력 부실"로 지적받을 수 있습니다. 반복 비용은 처음부터 예산에 충분히 반영하는 것이 올바른 재정 운용입니다.
  ...
  },
  {
    ...
    legal_basis: "지방회계법 제29조(지출원인행위), 지방재정법 제45조(추가경정예산)",
...
- 유사 구매 이력 확인 (전임자 처리 방식)
  ...
  },
  {
    ...
    severity: "중대",
    topic_slug: "budget-item-standard",
    legal_basis: "지방자치단체 업무추진비 집행에 관한 규칙, 지방재정법 제47조(예산의 목적 외 사용금지)",
...
- e나라도움 시스템에서 반환 처리 가능
  ...
  },
  {
    ...
    severity: "보통",
    topic_slug: "budget-execution",
    legal_basis: "지방회계법 제29조(지출원인행위), 지방자치단체 예산편성 운영기준",
