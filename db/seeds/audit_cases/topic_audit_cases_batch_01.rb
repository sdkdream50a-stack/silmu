...
AuditCase.find_or_initialize_by(slug: 'penalty-reduction-unauthorized').tap do |ac|
  ...
  ac.issue = '△△군 농어촌 도로 포장공사(계약금액 14억원)에서 시공사가 40일 지체되어 지연배상금 5,600만원이 발생하였음에도, 계약담당자가 계약상대자의 책임 없는 사유(지방계약법 시행령 제90조 제1항 후단)에 해당하는지 객관적으로 검토·입증하지 않은 채 부과 의무가 있는 지연배상금 전액을 단독 전결로 임의 면제하여 지방재정 손실을 초래하였고, 감사에서 적발되어 중징계 처분이 내려짐.'
...
공사 진행 중 지연 징후가 보이면 업체에 지연 원인 및 만회 대책을 **서면으로 제출**받아야 합니다. 이 과정에서 불가항력 사유가 있다면 공기 연장 절차(계약기간 연장)를 통해 처리하는 것이 적법하며, 이미 지체가 발생한 후 소급 감면하는 방식은 위법합니다.
  ...
  ac.action_taken = '계약담당자 정직 3개월 및 지연배상금 5,600만원 변상 명령, ◆◆건설 지연배상금 전액 납부, 지연배상금 면제·조정 시 책임 없는 사유 입증·합의제 검토 의무화, 최근 5년 지연배상금 면제·조정 내역 전수 재조사 실시'
