...
cases = [
  ...
  },
  {
    ...
    severity: "중대",
    category: "수의계약",
    legal_basis: "사학기관 재무·회계 규칙 제35조(계약의 원칙), 국가를 당사자로 하는 계약에 관한 법률 시행령 제26조(수의계약에 의할 수 있는 경우)·제30조(견적에 의한 가격 결정 등), (계약예규)정부입찰·계약집행기준 제10조의3(소액수의계약시 유의사항), 지방자치단체 입찰 및 계약집행기준(행정안전부 예규 제332호) 제1장",
    issue: <<~ISSUE,
