...
# Phase A~E 전수 검증 후 발견된 audit_case 3건 legal_basis 정정
# 정정 사유:
...
corrections = [
  ...
  {
    # 게이트 즉시 추가 적발: §36의2(성인지 예산서)를 예산편성 운영기준 위임으로 잘못 인용
...
puts "✅ 2026-05-19 회계·재정 인용 정정 batch 완료 (#{corrections.size}건)"
