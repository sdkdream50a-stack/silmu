...
AuditCase.find_or_create_by!(slug: 'guideline-excess-budget-compilation') do |ac|
  ...
  ac.legal_basis = '지방재정법 제38조 제2항(예산편성기준 — 행정안전부령 위임), 지방재정법 제41조(예산의 과목 구분), 행정안전부 「지방자치단체 예산편성 운영기준」'
...
지방자치단체의 장은 지방재정법 제38조 제2항에 따라 회계연도별 예산편성기준(행정안전부령으로 위임)을 따라야 하며, 실무에서는 행정안전부가 매년 시달하는 「지방자치단체 예산편성 운영기준」이 그 구체적 집행기준 역할을 합니다. 상위 법률에서 직접 위임한 기준이므로 법적 구속력이 인정되며, 의회 의결로 통과되었더라도 기준 초과 편성은 위법으로 판단됩니다.
  DETAIL
  ac.lesson = <<~LESSON
## 실무자가 반드시 기억해야 할 사항

### 1. 예산편성 운영기준은 법적 구속력이 있습니다
행안부 시달기준이라도 지방재정법 제38조 제2항에서 행정안전부령으로 직접 위임된 편성기준이므로, 지자체는 반드시 준수해야 합니다. "의회에서 통과됐으니 괜찮다"는 논리는 감사에서 통용되지 않습니다.
...
AuditCase.find_or_create_by!(slug: 'school-budget-without-committee-review') do |ac|
  ...
  ac.legal_basis = '초·중등교육법 제32조 ①항 제2호(학교운영위원회 심의 사항 — 학교의 예산안과 결산), 초·중등교육법 제31조(학교운영위원회의 설치), 초·중등교육법 제30조의2(학교회계의 설치), 초·중등교육법 시행령 제60조(심의결과의 시행 등)'
...
초·중등교육법 제32조 제1항 제2호는 학교 예산안을 학교운영위원회의 심의 사항으로 명시하고 있습니다. 이는 선택 사항이 아니라 법적 의무입니다.
