...
AuditCase.find_or_create_by!(slug: 'vehicle-travel-allowance-distance-fraud') do |ac|
  ...
  ac.legal_basis = '공무원여비규정 별표 2(자가용승용차 사용 시 여비 지급 기준) + 인사혁신처 「공무원 여비 업무 처리 기준」, 지방공무원 여비규정 별표(자가용 여비)'
...
공무원여비규정 별표 2(자가용승용차 사용 시 여비 지급 기준) 및 인사혁신처 「공무원 여비 업무 처리 기준」은 자가용 여비를 "출발지로부터 목적지까지의 실제 사용 거리"를 기준으로 계산합니다. 그러나 담당자들은 네비게이션 기준 최단 경로보다 훨씬 긴 우회 도로를 경로로 신고했습니다.
...
공무원여비규정 별표 2 및 인사혁신처 「공무원 여비 업무 처리 기준」은 자가용 여비를 "실제 사용 거리"를 기준으로 계산하도록 규정합니다. 불필요한 우회 경로는 실제 사용 거리로 인정받기 어렵습니다. 도로 공사·교통 통제 등 불가피한 우회가 있었다면 그 사유를 출장신청서에 구체적으로 기재하고, 가능하면 네비게이션 우회 안내 캡처를 첨부하세요.
