...
AuditCase.find_or_create_by!(slug: 'accommodation-allowance-false-claim') do |ac|
  ...
  ac.legal_basis = '공무원여비규정 제16조 제1항(숙박비·식비·일비)·별표 2(국내 여비 지급 기준표), 지방공무원 여비규정 제16조(숙박비), 형법 제227조의2(공전자기록등불실기재), 공무원 징계령 제2조'
...
공무원여비규정 제16조 제1항 및 지방공무원 여비규정은 숙박비를 별표 2 상한액 범위 내 실비로 지급하되, 다음 요건을 충족해야 합니다:
...
공무원여비규정 제16조 제1항은 숙박비를 별표 2 상한액 범위 내 실비로 지급하도록 규정하고 있습니다. 이는 영수증이 있다고 자동으로 지급되는 것이 아니라, **실제로 숙박한 사실**이 전제되어야 합니다. 영수증은 증빙 서류일 뿐, 숙박 사실 자체를 증명하지는 않습니다.
...
AuditCase.find_or_create_by!(slug: 'foreign-travel-private-tourism') do |ac|
  ...
  ac.legal_basis = '공무원 국외출장 등에 관한 예규 제4조(출장 목적), 지방공무원의 경우 각 지방자치단체 「지방공무원 여비 조례」(593건 라이브) 별표(국외여비)·행정안전부 「지방공무원 국외출장 업무처리 지침」 우선 적용, 국가공무원은 「공무원여비규정」 제3조(여비의 종류)·제25조(국외여비)'
...
AuditCase.find_or_create_by!(slug: 'travel-expense-double-claim') do |ac|
  ...
  ac.published = true
  ac.view_count = 0
  ac.topic_slug = 'concurrent-position'
  ac.legal_basis = '공무원여비규정 제4조(여비 지급의 원칙), 지방공무원 여비규정 제4조(여비 지급의 원칙), 지방공무원법 제56조(영리 업무 및 겸직 금지), 회계관계직원 등의 책임에 관한 법률 제4조'
...
AuditCase.find_or_create_by!(slug: 'vehicle-travel-allowance-distance-fraud') do |ac|
  ...
  ac.legal_basis = '공무원여비규정 별표 2(자가용승용차 사용 시 여비 지급 기준) + 인사혁신처 「공무원보수 등의 업무지침」(예규, 2026-01-22 시행), 지방공무원 여비규정 별표(자가용 여비)'
...
공무원여비규정 별표 2(자가용승용차 사용 시 여비 지급 기준) 및 인사혁신처 「공무원보수 등의 업무지침」(예규, 2026-01-22 시행)은 자가용 여비를 "출발지로부터 목적지까지의 실제 사용 거리"를 기준으로 계산합니다. 그러나 담당자들은 네비게이션 기준 최단 경로보다 훨씬 긴 우회 도로를 경로로 신고했습니다.
...
공무원여비규정 별표 2 및 인사혁신처 「공무원보수 등의 업무지침」(예규, 2026-01-22 시행)은 자가용 여비를 "실제 사용 거리"를 기준으로 계산하도록 규정합니다. 불필요한 우회 경로는 실제 사용 거리로 인정받기 어렵습니다. 도로 공사·교통 통제 등 불가피한 우회가 있었다면 그 사유를 출장신청서에 구체적으로 기재하고, 가능하면 네비게이션 우회 안내 캡처를 첨부하세요.
