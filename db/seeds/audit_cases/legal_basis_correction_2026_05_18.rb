...
corrections = [
  ...
  # 2026-05-18 Phase 2 #2 1차 batch 검증 중 발견 (§44=채무부담행위, 정책사업 간 이용은 §47)
  {
    slug: "budget-misuse",
    legal_basis: "지방재정법 제47조(예산의 목적 외 사용금지·정책사업 간 이용·예산 이체)",
    issue: "도로 보수 예산 3억원 중 2억원을 정책사업 간 이용하여 청사 리모델링에 사용함. " \
           "이는 정책사업 간 예산 이동(이용)으로 지방의회 의결이 필요한 사항임에도 의회 의결 없이 단체장 결재만으로 처리함. " \
           "지방재정법 제47조는 예산의 목적 외 사용을 금지하고, 정책사업 간 이용은 의회 의결을 받도록 규정하고 있으나, 이를 위반함."
  }
]
