...
enrichments = [
  {
    ...
    detail: <<~DETAIL,
      ...
      > ※ 본 사례는 감사원·자치단체 감사결과보고서에 반복적으로 등장하는 패턴을 기반으로 작성된 **가상 시나리오**입니다. 특정 지방자치단체의 실제 사례가 아니며, 학습·실무 적용을 위한 교육용 자료입니다. 현행 법령 기준일: 지방재정법 2025-04-01 시행(법률 제20871호).
    DETAIL
    lesson: <<~LESSON
  ...
  },
  {
    ...
    detail: <<~DETAIL,
      ...
      > ※ 본 사례는 감사원·자치단체 감사결과보고서에 반복적으로 등장하는 패턴을 기반으로 작성된 **가상 시나리오**입니다. 특정 지방자치단체의 실제 사례가 아니며, 학습·실무 적용을 위한 교육용 자료입니다. 처분 수위는 「지방공무원 징계규칙」과 유사 사례 평균을 참고했으나 개별 사건의 결과는 정상참작 요인에 따라 달라질 수 있습니다. 현행 법령 기준일: 지방재정법 2025-04-01 시행(법률 제20871호).
    DETAIL
    lesson: <<~LESSON
      ## 이용·전용 구분, 반드시 외워두세요
