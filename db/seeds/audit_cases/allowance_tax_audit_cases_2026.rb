...
"내부 검토 중", "공개 곤란" 등 막연한 표현은 위법한 처분으로 이의신청 인용 대상이 됩니다.
  ...
  },
  {
    ...
    legal_basis: "지방공무원 수당 등에 관한 규정 제10조(가족수당) / 공무원수당 등에 관한 규정 제10조(가족수당), 지방공무원법 제45조(보수에 관한 규정) / 국가공무원법 제47조(보수에 관한 규정 준수 의무)",
...
부당 수령한 수당은 이자와 함께 전액 반환해야 합니다. 고의 미신고가 확인되면 징계 처분(최소 경고)까지 받을 수 있으며, 반복 수령 시 중징계 대상이 됩니다.
  ...
  },
  {
    ...
    legal_basis: "지방공무원 수당 등에 관한 규정 제18조의3(명절 휴가비) / 공무원수당 등에 관한 규정 제18조의3, 행정안전부 「지방공무원 보수업무 등 처리지침」 / 인사혁신처 「공무원 보수 등의 업무지침」",
...
잘못 지급된 수당은 법적 환수 근거에 따라 반환을 요청해야 합니다. 자진 반환이 이루어지지 않을 경우 급여에서 공제 처리할 수 있으며, 이를 방치하면 담당자도 변상 책임을 질 수 있습니다.
  ...
  },
  {
    ...
    legal_basis: "지방공무원 수당 등에 관한 규정 제7조의2(성과상여금) / 공무원수당 등에 관한 규정 제7조의2, 지방공무원 평정규칙·지방공무원법 제48조(성실의 의무) / 공무원 성과평가 등에 관한 규정 제26조·국가공무원법 제56조(성실 의무)",
