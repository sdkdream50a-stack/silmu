...
guides_data = [
  ...
  },
  {
    ...
    sections: {
      ...
      step3: { title: "전자계약 체결", items: [ "낙찰자와 나라장터 전자계약 시스템을 통해 계약서를 체결합니다.", "공동인증서(구 공인인증서)로 전자서명하여 계약서를 완성합니다.", "계약보증금 납부는 전자보증서(서울보증보험 등)로 가능합니다.", "계약 체결 후 계약서 원본이 시스템에 자동 보관됩니다." ] },
