...
#   시행령: §9/§10=예정가격(작성·결정기준)·§13=참가자격·§42=재정지출부담입찰 낙찰자결정·§49/§50=계약서(기재·생략)·§64/§66=검사(기한·조서)·§78=장기계속.
...
VERIFIED_2026_06_09_B2 = {
  ...
  "contract-execution" =>
    "법제처 — 지방계약법 §14(계약서 작성·생략·성립), 시행령 §49(기재: 목적·금액·이행기간·보증금·지체상금)·§50(생략: 물품/용역 5천만·공사 1억 이하). 운영(silmu.kr) 정본 일치 확인",
  "bid-qualification" =>
