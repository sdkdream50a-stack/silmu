...
QUICK_STATS_SPRINT3 = {
  ...
  # 낙찰하한율 (id:38, 475회)
  "lowest-bid-rate" => [
    { "label" => "현행 하한율", "value" => "89.745%", "note" => "10억 미만 공사 · 지방 2025.7.1~" },
    { "label" => "이전 하한율", "value" => "87.745%", "note" => "지방 2025.6.30 공고분까지" },
    { "label" => "물품·용역",   "value" => "별도 기준", "note" => "2인 견적 수의 88%(2천만원 이하 90%)" }
  ],
  ...
  "travel-expense-settlement" => [
    { "label" => "일비",   "value" => "2.5만원/일",    "note" => "직급 공통" },
    { "label" => "식비",   "value" => "2.5만원/일",  "note" => "직급 공통" },
  ...
  "domestic-travel-allowance" => [
    { "label" => "일비",       "value" => "2.5만원/일",   "note" => "직급 공통" },
    { "label" => "식비",       "value" => "2.5만원/일", "note" => "직급 공통" },
    { "label" => "숙박비 상한", "value" => "서울 10만·광역시 8만·그 밖 7만원",   "note" => "실비 · 공무원 여비 규정 별표 2" }
  ],
