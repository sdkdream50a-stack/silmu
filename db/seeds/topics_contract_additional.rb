...
topics = [
  ...
  },
  {
    ...
    law_content: <<~CONTENT,
      ...
      **지방계약법 제13조 (낙찰자의 결정)**
      ...
      <div style="background:#f3f4f6;padding:12px;border-radius:8px;margin:8px 0;">
      ※ 관련 법령: 지방계약법 시행령 제42조(적격심사), 지방자치단체 입찰 시 낙찰자 결정기준(행정안전부 예규)
      </div>
    CONTENT
    decree_content: <<~CONTENT,
      ## 지방계약법 시행령 제42조 (재정지출의 부담이 되는 입찰에서의 낙찰자 결정) 및 적격심사 세부기준
      ...
      **적격심사 세부 배점기준 (시행령 제42조제2항 · 「지방자치단체 입찰 시 낙찰자 결정기준」 행정안전부 예규)**
      ...
      **물품·용역 적격심사:**
      ...
      낙찰하한율: 공사 89.745%(10억원 미만) 등 추정가격 구간별 상이 (「지방자치단체 입찰 시 낙찰자 결정기준」 행안부 예규, 2026년 2%p 상향)
      </div>
    CONTENT
    rule_content: <<~CONTENT,
      ...
      2. 적격심사 서류 제출 요청
      3. 이행능력·가격·신인도 종합 평가
      4. 합격 점수 이상(공사 95점, 물품·용역 92점) + 낙찰하한율 이상 → 낙찰
      5. 미달 시 차순위자 심사
    ...
    CONTENT
    faqs: [
      { question: "낙찰하한율이 뭔가요?", answer: "예정가격 대비 낙찰 가능한 최저 비율입니다. 예를 들어 낙찰하한율 89.745%라면, 예정가격 1억원 공사에서 89,745,000원 이상 입찰해야 낙찰이 가능합니다. 이보다 낮은 금액으로 입찰하면 낙찰 불가입니다. (「지방자치단체 입찰 시 낙찰자 결정기준」 행안부 예규, 2026년 2%p 상향)" },
      { question: "적격심사에서 탈락하면?", answer: "적격심사 점수 미달(공사 95점 미만 — 100억 미만 기준, 물품·용역 92점 미만) 또는 낙찰하한율 미만이면 다음 순위 입찰자를 심사합니다. 모든 입찰자 탈락 시 유찰 처리됩니다. 구체적 합격 점수는 행안부 고시(낙찰자 결정기준)를 확인하세요." },
  ...
  },
  {
    ...
    law_content: <<~CONTENT,
      ## 지방계약법 제9조 (계약의 방법) 및 시행령 제18조 (2단계 입찰)
      ...
      **지방계약법 시행령 제18조 제3항 (규격입찰과 가격입찰의 분리)**
      ...
      <div style="background:#f3f4f6;padding:12px;border-radius:8px;margin:8px 0;">
      ※ 관련 법령: 지방계약법 시행령 제18조 제3항, 지방자치단체 물품계약 운용요령
      </div>
    CONTENT
    decree_content: <<~CONTENT,
      ## 지방계약법 시행령 제18조 제3항 (규격입찰과 가격입찰의 분리)
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "예정가격보다 낮게 입찰하면 무조건 낙찰인가요?", answer: "예정가격 이하여야 낙찰 가능하지만, 적격심사가 있는 경우 낙찰하한율(공사 89.745%(10억원 미만) 등 추정가격 구간별 상이) 이상이어야 합니다. 예정가격보다 낮더라도 낙찰하한율 미만이면 낙찰될 수 없습니다. (「지방자치단체 입찰 시 낙찰자 결정기준」 행안부 예규, 2026년 2%p 상향)" }
    ].to_json,
    practical_tips: <<~HTML
      <div class="space-y-4">
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
