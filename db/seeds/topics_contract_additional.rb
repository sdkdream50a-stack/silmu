  ...
  },
  {
    ...
    decree_content: <<~CONTENT,
      ...
      **물품·용역 적격심사:**
      ...
      낙찰하한율: 공사 89.745%~90%(추정가격 구간별 상이, 행정안전부 예규 제325호, 2025.7.1. 시행)
      </div>
    CONTENT
    rule_content: <<~CONTENT,
    ...
    CONTENT
    faqs: [
      { question: "낙찰하한율이 뭔가요?", answer: "예정가격 대비 낙찰 가능한 최저 비율입니다. 예를 들어 낙찰하한율 89.745%라면, 예정가격 1억원 공사에서 89,745,000원 이상 입찰해야 낙찰이 가능합니다. 이보다 낮은 금액으로 입찰하면 낙찰 불가입니다. (행안부 예규 제325호, 2025.7.1. 시행)" },
