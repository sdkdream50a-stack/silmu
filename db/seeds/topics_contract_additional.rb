...
topics = [
  ...
  },
  {
    ...
    rule_content: <<~CONTENT,
      ...
      2. 적격심사 서류 제출 요청
      3. 이행능력·가격·신인도 종합 평가
      4. 합격 점수 이상(공사 85점, 물품·용역 92점) + 낙찰하한율 이상 → 낙찰
      5. 미달 시 차순위자 심사
    ...
    faqs: [
      ...
      { question: "적격심사에서 탈락하면?", answer: "적격심사 점수 미달(공사 85점 미만, 물품·용역 92점 미만) 또는 낙찰하한율 미만이면 다음 순위 입찰자를 심사합니다. 모든 입찰자 탈락 시 유찰 처리됩니다. 구체적 합격 점수는 행안부 고시(낙찰자 결정기준)를 확인하세요." },
