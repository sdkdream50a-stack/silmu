...
attrs = {
  ...
  keywords: "재무관, 지출관, 출납공무원, 지출원, 출납원, 회계관계공무원, 회계관계직원, 변상책임, 내부통제, 세입징수관, 물품관리관",
  law_content: <<~CONTENT,
    ## 회계관계직원 등의 책임에 관한 법률 + 국고금관리법 + 지방회계법

    **회계관계직원 등의 책임에 관한 법률 주요 조항**

    <div style="background:#dbeafe;padding:12px;border-radius:8px;margin:8px 0;">
    **제2조 (정의)**
    "회계관계직원"이란 국가의 예산·회계 법령(국가재정법·국가회계법·국고금관리법 등), 지방자치단체의 예산·회계 법령(지방재정법·지방회계법 등), 감사원 감사 대상 단체의 회계사무를 집행하는 사람 및 그 보조자를 말한다.

    **제4조 (회계관계직원의 변상책임)**
    ① 고의 또는 중대한 과실로 법령·규정·예산을 위반하여 국가·지방자치단체·감사원 감사 대상 단체의 재산에 손해를 끼친 경우 변상 책임.
    ② 현금·물품을 출납·보관하는 회계관계직원이 선량한 관리자의 주의를 게을리하여 망실·훼손한 경우 변상 책임.
    ③ 스스로 사무를 집행하지 않았다는 이유로 책임 면제 불가.
    ④ 2명 이상의 행위로 발생한 손해는 각자가 손해발생에 미친 정도에 따라 변상.
    </div>

    **회계 직책 — 국가(국고금관리법) vs 지방(지방회계법)**

    <div style="background:#dbeafe;padding:12px;border-radius:8px;margin:8px 0;">
    **[국가] 국고금관리법**
    - **재무관** (제22조 ①): 지출원인행위 — 중앙관서의 장 또는 제21조에 따라 위임받은 공무원
    - **지출관** (제22조 ①): 지출 — 중앙관서의 장이 임명한 공무원
    - **출납공무원** (제4조의3): 자금 출납·보관 — 중앙관서의 장 또는 위임받은 공무원이 임명
    - **분리 원칙** (제27조): 재무관·지출관·출납공무원의 직무 겸직 금지

    **[지방] 지방회계법 제46조 ("회계관계공무원"의 법령상 정의)**
    "징수관·재무관·재산관리관·물품관리관·채권관리관·부채관리관·**지출원**·**출납원**과 그 대리인·분임자 등"
    - **재무관**: 지출원인행위
    - **지출원** (제46조): 국가의 "지출관"에 해당하는 지방 직책
    - **출납원** (제44조): 현금·물품 출납·보관
    - **분리 원칙** (제36조): 지출기관과 출납기관의 분리
    </div>

    <div style="background:#eff6ff;padding:12px;border-radius:8px;margin:8px 0;">
    📌 **위임 체계**: 국가는 국고금관리법, 지방은 지방회계법이 각 직책을 규정하고, 변상 책임의 기준은 「회계관계직원 등의 책임에 관한 법률」에서 통일적으로 정합니다. 지방회계법 제49조는 "회계관계공무원의 책임에 관하여는 회계관계직원법에서 정하는 바에 따른다"라고 명시적으로 위임합니다.
    </div>

    <div style="background:#f3f4f6;padding:12px;border-radius:8px;margin:8px 0;">
    ⚖️ **관련 법령**: 회계관계직원 등의 책임에 관한 법률, 국고금관리법, 지방회계법, 국가재정법, 지방재정법, 감사원법 제31~34조(변상판정·징계요구)
    </div>
  CONTENT
  ...
  rule_content: <<~CONTENT,
    ...
    **감사원 감사 vs 지방의회 결산 감사**
    ...
    ※ 지방자치법 결산심사 조문번호는 2022년 전부개정으로 변경되었을 수 있으므로, 법제처 국가법령정보센터에서 현행 조문을 확인하시기 바랍니다.
  CONTENT
