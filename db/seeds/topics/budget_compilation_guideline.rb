...
attrs = {
  ...
  law_content: <<~CONTENT,
    <strong>지방재정법 제38조 (지방자치단체 재정운용 업무편람 등)</strong>

    <div style="background:#dbeafe;padding:12px;border-radius:8px;margin:8px 0;">
    ① 행정안전부장관은 국가 및 지방 재정의 운용 여건, 지방재정제도의 개요 등 지방자치단체의 재정운용에 필요한 정보로 구성된 회계연도별 지방자치단체 재정운용 업무편람을 작성하여 지방자치단체에 보급할 수 있다.
    ...
    📌 위임 체계: 지방재정법 제38조 제2항이 회계연도별 예산편성기준을 <strong>행정안전부령</strong>으로 정하도록 위임합니다. 실무에서는 행정안전부가 매년 「지방자치단체 예산편성 운영기준」을 시달하여 구체적인 편성 단가·기준을 정합니다(같은 조 제3항).
    </div>

    <div style="background:#f3f4f6;padding:12px;border-radius:8px;margin:8px 0;">
    ⚖️ 관련 법령: 지방재정법 제41조(예산의 과목 구분) — 세입예산은 장·관·항으로, 세출예산은 분야·부문·정책사업·단위사업·세부사업·목으로 구분 / 같은 법 시행령 제47조(예산의 과목구분 및 설정) / 지방재정법 제47조(목적 외 사용금지)·제47조의2(이용·이체)·제49조(전용)
    </div>
  CONTENT
  decree_content: <<~CONTENT,
    <strong>지방재정법 시행령 제47조 (예산의 과목구분 및 설정)</strong>

    <div style="background:#dbeafe;padding:12px;border-radius:8px;margin:8px 0;">
    ① 세입예산의 과목은 세입의 원천을 고려하여 지방세수입·세외수입·지방교부세·조정교부금·보조금·지방채 및 예치금회수 등으로 구분한다.
    ...
    <div style="background:#eff6ff;padding:12px;border-radius:8px;margin:8px 0;">
    ■ 예산편성 운영기준과의 관계: 행안부가 매년 시달하는 「지방자치단체 예산편성 운영기준」은 모법 제38조 제2항(행정안전부령 위임) 및 시행령 제47조 제3항(행정안전부장관의 세부사항 정함)을 근거로 작성되어, 각 목(目)별 편성 한도·단가 기준을 구체적으로 정합니다.
    </div>
