...
attrs = {
  ...
  keywords: "병가, 공무원 병가, 지방공무원 병가, 공무상 병가, 병가 일수, 진단서, 병가 급여, 복무규정, 질병휴직, 지방공무원법 제63조",
  law_content: <<~CONTENT,
    ## 국가공무원법 (휴가 및 휴직 근거)

    <strong>국가공무원법 제52조 (근무 기간 중 휴가)</strong>
    ...
    📌 <strong>위임 체계:</strong> 국가공무원법 제52조의 위임에 따라 「국가공무원 복무규정」(대통령령)에서 병가의 종류, 허용 일수, 진단서 제출 기준 등을 구체적으로 규정합니다. 병가 허용 일수(일반 60일, 공무상 180일)와 진단서 면제 기준(연 6일 이내) 등은 모두 복무규정 제18조에 규정되어 있습니다.
    </div>

    <strong>국가공무원법 제71조 제1항 제1호 (휴직 - 질병)</strong>
    ...
    ⚖️ <strong>관련 법령:</strong> 지방공무원의 경우 「지방공무원법」 제63조제1항제1호(장기요양)·제64조제1호(휴직기간 1년·공무상 3년)·「지방공무원 복무규정」(병가)이 우선 적용됩니다. 국가공무원은 「국가공무원법」 제71조제1항제1호·「국가공무원 복무규정」 제18조(병가). 공무상 재해 관련 요양급여는 「공무원 재해보상법」(2018.9.21. 시행)이 공통 근거 법률이며, 휴직자의 보수는 「지방공무원 보수규정」 또는 「공무원보수규정」에서 정합니다.
    </div>
  CONTENT
