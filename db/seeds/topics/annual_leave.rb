...
attrs = {
  ...
  keywords: "연가, 공무원 연가, 지방공무원 연가, 지방공무원 복무규정 제7조, 연가일수, 연가보상비, 연가 사용, 복무규정, 연차휴가, 잔여연가",
  law_content: <<~CONTENT,
    ## 국가공무원법 제41조 (휴가)
    ...
    **관련 법령**
    - <b>지방공무원</b>: 「지방공무원 복무규정」 제7조(재직기간별 연가일수)·제7조의2~제7조의6(병가·공가·특별휴가 등) — 국가공무원 복무규정과 거의 동일 구조이나 일부 기관 조례·규칙에서 별도 운영
    - <b>국가공무원</b>: 「국가공무원법」 제41조(휴가), 「국가공무원 복무규정」 제15조(연가일수)·제15조의2(연가 저축)·제16조(연가보상비)
    </div>
  CONTENT
