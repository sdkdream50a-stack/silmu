...
attrs = {
  ...
  keywords: "지출원인행위, 재무관, 지출결의, 품의서, 예산 범위, 지방회계법 제29조, 계약 전 품의, 집행 절차",
  law_content: <<~CONTENT,
    ## 지방회계법 제29조 (지출원인행위)
    ...
    **지방회계법 제29조 (지출원인행위)**
    ...
    ② 지방자치단체의 장은 소속 공무원에게 위임하여 지출원인행위를 하게 할 수 있다. 이 경우 위임을 받은 공무원을 "재무관"이라 한다.
    ...
    ※ 2016년 지방회계법 제정·시행으로 지출·회계 관련 조문이 지방재정법 → 지방회계법으로 이관되었습니다.
    - **지방회계법 제2조·제7조**: 회계관계공무원 정의 (재무관·지출관·출납원)
    - **지방회계법 제29조**: 지출원인행위 (재무관 담당)
    - **지방회계법 제32조**: 지출 (지출관 담당)
    - **지방회계법 제49조**: 변상명령
    </div>
    ...
    **회계관계직원 등의 책임에 관한 법률 제4조 (변상 책임)**
    ...
    ⚠️ 조문의 정확한 현행본은 법제처 국가법령정보센터(law.go.kr)에서 최종 확인을 권장합니다.
  CONTENT
  decree_content: <<~CONTENT,
    ## 지방회계법 시행령 — 지출원인행위의 범위 및 시기

    <div style="background:#dcfce7;padding:12px;border-radius:8px;margin:8px 0;">
    지방회계법 제29조에 따라 지출원인행위의 범위, 시기 등은 지방자치단체의 세출예산 및 계속비의 금액 범위에서 하되, 그 구체적인 유형별 시기는 지방회계법 시행령에서 정한다.
    ※ 정확한 시행령 조문 번호는 법제처 국가법령정보센터에서 확인을 권장합니다.
    </div>
