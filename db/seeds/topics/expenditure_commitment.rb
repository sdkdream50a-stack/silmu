...
attrs = {
  ...
  law_content: <<~CONTENT,
    ...
    **회계관계공무원 등의 책임에 관한 법률 제4조 (변상 책임)**

    <div style="background:#f3f4f6;padding:12px;border-radius:8px;margin:8px 0;">
    회계관계공무원이 고의 또는 중대한 과실로 법령이나 그 밖의 관계 규정을 위반하여 국가 또는 지방자치단체에 손해를 끼쳤을 때에는 변상할 책임이 있다.
    ※ 재무관(지출원인행위 담당)도 회계관계공무원으로서 변상 책임 대상
    </div>
  ...
  qa_content: <<~CONTENT,
    ...
    **Q. 재무관이 실수로 예산을 초과한 지출원인행위를 하면?**
    A. 고의가 없더라도 중과실이 인정되면 회계관계공무원법에 따라 변상 책임이 발생할 수 있습니다. 예산 잔액을 사전에 반드시 확인하는 것이 중요합니다.
