...
attrs = {
  ...
  decree_content: <<~CONTENT,
    ...
    지방회계법 제29조 제2항에 따라 재무관(지방자치단체의 장 또는 위임받은 공무원)이 지출원인행위를 할 때에는 <strong>법령, 조례 및 규칙에서 정하는 바에 따라 배정된 예산의 범위에서</strong> 하여야 합니다(법 제29조 ②항). 구체적인 유형별 발생 시점은 행정안전부 「지방회계 운영 기준」 등 행정규칙에서 정합니다.
