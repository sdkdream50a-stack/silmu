...
attrs = {
  ...
  law_content: <<~CONTENT,
    ...
    **지방재정법 제38조 (지출원인행위)**
    ...
    ② 지출원인행위를 수행하는 공무원을 "재무관"이라 하며, 재무관은 예산 범위를 초과하는 지출원인행위를 하여서는 아니 된다.

    ③ 재무관은 지출원인행위를 하기 전에 예산 잔액을 확인하고, 이를 회계 장부에 기록하여야 한다.
    </div>

    **회계관계공무원 등의 책임에 관한 법률 (회계관계공무원법) 제4조**

    <div style="background:#f3f4f6;padding:12px;border-radius:8px;margin:8px 0;">
    재무관이 고의 또는 중대한 과실로 국가나 지방자치단체에 손해를 끼쳤을 때에는 그 손해를 배상하여야 한다.
    ※ 변상 책임은 재무관(지출원인행위자)에게도 적용됨
    </div>
  CONTENT
