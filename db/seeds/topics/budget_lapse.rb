...
attrs = {
  ...
  law_content: <<~CONTENT,
    ...
    **지방재정법 제50조 제2항 (사고이월) — 사유 4가지**

    <div style="background:#dbeafe;padding:12px;border-radius:8px;margin:8px 0;">
    세출예산 중 다음 각 호의 어느 하나에 해당하는 경비는 사고이월비로서 다음 회계연도에 이월할 수 있다.
    1. 회계연도 내에 지출원인행위를 하고 불가피한 사유로 회계연도 내에 지출하지 못한 경비와 부대 경비
    2. 입찰공고 후 지출원인행위까지 오랜 기간이 걸리는 경우로서 대통령령으로 정하는 경비
    3. 공익·공공 사업의 손실보상비로서 대통령령으로 정하는 경비
    4. 경상적 성격의 경비로서 대통령령으로 정하는 경비
    </div>

    **지방재정법 제7조 (회계연도 독립의 원칙)**

    <div style="background:#f3f4f6;padding:12px;border-radius:8px;margin:8px 0;">
    각 회계연도의 경비는 그 연도의 세입으로 충당하여야 한다.
    ※ 이 원칙의 예외가 명시이월과 사고이월(제50조)
    </div>

    **결산상 잉여금(세계잉여금) — 지방회계법에 의한 처리**

    <div style="background:#dbeafe;padding:12px;border-radius:8px;margin:8px 0;">
    매 회계연도 결산상 잉여금은 지방회계법의 결산 절차에 따라 처리됩니다. 결산서에 첨부되는 이월명세서·명시이월비 집행명세서·국고보조금 반납명세서 등으로 이월·불용·세계잉여금의 흐름이 정리됩니다(지방회계법 제17조).
    </div>

    <div style="background:#eff6ff;padding:12px;border-radius:8px;margin:8px 0;">
    📌 <strong>위임 체계:</strong> 지방재정법 제50조 제2항 제2호~제4호의 "대통령령으로 정하는 경비"는 시행령에 별도로 위임되어 있으며, 같은 조 제1호의 사고이월 본조 요건은 모법에 직접 규정됩니다. 회계연도 독립 원칙(제7조)이 이월의 예외적 성격을 규정합니다.
    </div>
  CONTENT
  decree_content: <<~CONTENT,
    ...
    **사고이월 인정 요건 (지방재정법 제50조 제2항 — 4가지 법정 사유)**

    <div style="background:#eff6ff;padding:12px;border-radius:8px;margin:8px 0;">
    사고이월은 다음 4가지 법정 사유 중 하나에 해당해야 합니다(같은 조 제2항 각 호).
    1. <strong>지출원인행위 완료 + 불가피 미지출</strong>: 회계연도 내 지출원인행위를 하였으나 불가피한 사유로 회계연도 내에 지출하지 못한 경비(부대경비 포함)
    2. <strong>입찰공고 후 장기소요 경비</strong>: 입찰공고 후 지출원인행위까지 오랜 기간이 걸리는 경우(대통령령 위임)
    3. <strong>공익·공공사업 손실보상비</strong>: 토지 수용 등에 따른 손실보상비(대통령령 위임)
    4. <strong>경상적 성격의 경비</strong>: 경상적 성격을 갖는 경비 중 대통령령으로 정하는 것

    ※ 실무 적용 시 "재해·재난으로 인한 공사 중단", "계약 상대방의 부도", "재판 계류" 등은 모두 위 1호의 "불가피한 사유"에 해당하며, 사고이월 신청 시 사유의 구체적 입증이 필요합니다.
    </div>
  CONTENT
  rule_content: <<~CONTENT,
    ## 불용액 처리 실무 기준

    **불용(不用) 처리 기준 (행정안전부 예산편성 운영기준)**
    ...
    **이월 신청·승인 절차 (지방재정법 시행규칙 및 행정 지침)**
    ...
    ⚖️ 결산상 잉여금(세계잉여금)은 지방회계법의 결산 절차에 따라 처리되며, 실무에서는 지방채 원리금 상환·다음 연도 세입 이입 등 자치단체별 결산 운용 기준에 따라 집행됩니다.
  CONTENT
