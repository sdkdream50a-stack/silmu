...
attrs = {
  ...
  keywords: "징계, 공무원 징계, 지방공무원 징계, 지방공무원법 제69조, 지방공무원법 제70조, 파면, 해임, 강등, 정직, 감봉, 견책, 징계위원회, 소청심사",
  law_content: <<~CONTENT,
    ## 국가공무원법 제79조 (징계의 종류)
    ...
    **국가공무원법 제79조 (징계의 종류)**
    ...
    ⚖️ <strong>관련 법령:</strong> <b>지방공무원</b> — 「지방공무원법」 제69조(징계사유)·제70조(징계의 종류 — 파면·해임·강등·정직·감봉·견책)·제73조(징계의 관리 — 감사·수사 중 절차 정지), 「지방공무원 징계 및 소청 규정」. <b>국가공무원</b> — 「국가공무원법」 제78조(징계 사유)·제78조의2(징계부가금)·제79조(징계의 종류), 「공무원 징계령」, 「공무원 비위사건 처리규정」.
    </div>
  CONTENT
