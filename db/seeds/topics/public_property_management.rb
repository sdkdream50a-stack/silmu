...
attrs = {
  ...
  decree_content: <<~CONTENT,
    ...
    **사용허가·대부 기간 (시행령 기준)**
    ...
    <div style="background:#eff6ff;padding:12px;border-radius:8px;margin:8px 0;">
    - **행정재산 사용허가**: 1회 5년 이내, 갱신 가능
    - **일반재산 대부**: 원칙 5년 이내 (토지·건물 최대 20년)
  ...
  rule_content: <<~CONTENT,
    ...
    **지방의회 의결 필요 경우 (공유재산법 제20조의2)**

    <div style="background:#fee2e2;padding:12px;border-radius:8px;margin:8px 0;">
    - 중요 재산 처분 (조례로 정한 금액 이상)
    - 행정재산의 목적 외 사용허가 중 일정 규모 이상
    - 기부채납 재산의 반환

    ※ 조례별로 기준 금액이 다르므로 해당 지방자치단체 조례 확인 필요
    </div>
