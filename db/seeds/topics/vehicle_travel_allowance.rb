...
attrs = {
  ...
  keywords: "자가용 출장, 유류비, 출장 교통비, 개인차량 출장, km당 여비, 통행료, 주차비, 공무원여비규정, 지방공무원 여비 조례",
  law_content: <<~CONTENT,
    ## 국가공무원법 제46조 (실비 변상)
    ...
    **국가공무원법 제46조 (실비 변상)**
    ...
    - <b>지방공무원</b>: 각 지방자치단체 「지방공무원 여비 조례」(593건 라이브)의 자동차 운임·자가용 출장 기준. 일반적으로 「공무원여비규정」 별표 2의 구조를 따르되 단가는 지자체별 상이.<br>
    - <b>국가공무원</b>: 「국가공무원법」 제46조 (실비 변상 → 대통령령 위임), 「공무원여비규정」 (대통령령) — 운임·일비·식비·숙박비 등 구체적 기준.<br>
