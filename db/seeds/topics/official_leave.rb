...
attrs = {
  ...
  keywords: "공가, 공무원 공가, 지방공무원 공가, 지방공무원 복무규정, 예비군 공가, 민방위 공가, 건강검진 공가, 공가 사유, 복무규정",
  law_content: <<~CONTENT,
    ...
    **국가공무원법 제52조 (근무시간 등)**
    ...
    - <b>지방공무원</b>: 「지방공무원 복무규정」(대통령령) 제7조의3·제7조의4(병가·공가·특별휴가 등) 및 각 지방자치단체 「공무원 복무 조례」<br>
    - <b>국가공무원</b>: 「국가공무원법」 제52조 → 「국가공무원 복무규정」(대통령령) 제15조(연가)·제18조(병가)·제19조(공가)·제20조(특별휴가)
    </div>
  CONTENT
