...
attrs = {
  ...
  law_content: <<~CONTENT,
    ...
    **보조금 관리에 관한 법률 (보조금법)**
    ...
    📌 **위임 체계**: 보조금법(법률) → 보조금법 시행령(대통령령, 교부 신청 서류·변경 승인·정산 등 구체적 절차) → 보조금법 시행규칙(기획예산처령, 서식) → 보조금 관리 기준(기획예산처 예규, 집행 세부기준) → e나라도움 시스템(통합관리). 실적보고 기한 등 세부 절차는 시행령에서 규정합니다.
    </div>
  ...
  rule_content: <<~CONTENT,
    ...
    **보조금 관리 기준 (기획예산처 예규)**
    ...
    기획예산처가 매년 고시하는 「보조금 관리 기준」은 보조금법 시행령에 따라 보조사업 집행의 세부기준을 정합니다:
