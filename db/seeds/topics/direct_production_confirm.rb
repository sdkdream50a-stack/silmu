...
attrs = {
  ...
  law_content: <<~CONTENT,
    ...
    **중소기업제품 구매촉진 및 판로지원에 관한 법률 제12조 (직접생산확인)**
    ...
    ② 직접생산확인은 「중소기업기술정보진흥원」에서 현장 확인을 거쳐 발급한다.
  ...
  decree_content: <<~CONTENT,
    ...
    **직접생산확인 처리 흐름**
    ...
    1. 중소기업기술정보진흥원 SMPP(www.smpp.go.kr) 온라인 신청
  ...
  qa_content: <<~CONTENT,
    ...
    **Q. 모든 공공기관 납품에 직접생산확인이 필요한가요?**
    A. 아닙니다. 중소기업 간 경쟁 제품으로 지정된 품목(중소기업청 고시)에 한하여 적용됩니다. 해당 품목이 아닌 경우 직접생산확인 없이 납품 가능합니다.
