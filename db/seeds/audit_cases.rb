cases = [
  ...
  },
  {
    ...
    checkpoints: [
      ...
      { icon: "calculate", title: "요율 적용", desc: "공사 0.5/1,000, 물품 제조·구매 0.8/1,000, 용역 1.3/1,000, 운송 2.5/1,000, 임대차 1.0/1,000 (시행규칙 제75조)" },
