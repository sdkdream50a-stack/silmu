cases = [
  # === 수의계약 분야 ===
  {
    ...
    category: "수의계약",
    severity: "중대",
    issue: "추정가격 2,200만원인 물품 구매를 수의계약으로 체결하였으나, 물품 수의계약 한도액(2,200만원 이하)을 초과하는 것으로 확인됨. 부가가치세를 포함한 금액을 추정가격으로 잘못 산정하여 한도 이내로 착각한 사례.",
  ...
  },
  {
    ...
    lesson: "추정가격 구간에 따른 견적 징구 기준(1인/2인)을 정확히 구분해야 합니다. 물품·용역 500만원 초과 시 2인 이상 견적 비교가 원칙입니다.",
  ...
  # === 기타 분야 ===
  {
    ...
    legal_basis: "지방계약법 시행령 제8조, 형법 제129조",
