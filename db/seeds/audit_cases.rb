cases = [
  ...
  },
  {
    ...
    checkpoints: [
      ...
      { icon: "price_check", title: "상한 확인", desc: "지체상금 합계가 계약금액의 10% 이내인지 확인 (지방계약법 시행규칙 §75 단서)" }
    ].to_json,
    topic_slug: "late-penalty"
  },
  {
